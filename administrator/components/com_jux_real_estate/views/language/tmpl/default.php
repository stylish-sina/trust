...
<form action="<?php echo JRoute::_('index.php?option=com_jux_real_estate&view=language'); ?>" method="POST" name="adminForm" id="adminForm">
    ...
    <input type="hidden" name="extension_name" id="extension_name" value="<?php if(isset($_REQUEST['extension_name']) && $_REQUEST['extension_name']){echo $_REQUEST['extension_name'];} ?>">
    <input type="hidden" name="lang" id="lang" value="">
    <input type="hidden" name="site" id="site" value="">
    <input type="hidden" name="option" value="com_jux_real_estate">
    <input type="hidden" name="boxchecked" value="0">
    <input type="hidden" name="item" value="<?php if(isset($_REQUEST['extension_name']) && $_REQUEST['extension_name']){echo $_REQUEST['extension_name'];} ?>" />
</form>
