...
class JUX_Real_EstateModelForm extends JModelForm {
    ...
    function updateCount($agent_id = null) {
	$user = &JFactory::getUser();
...
//			'list.select', ' DISTINCT a.*, a.count AS `count`, p.name AS `plan`,  p.days AS `days`, a.count_limit AS `plan_countlimit`'
	...
	$target_dir = 'images/jux_real_estate/';
