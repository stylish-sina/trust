...
<div class="jux-row addagent">
                                ...
                                <div class="plan-header">
                                    ...
                                    <h3 class="plan-value">
                                        <span class="noo-price">
                                            ...
                                            ?>
                                        </span>/ <?php echo JText::_('COM_JUX_REAL_ESTATE_MONTHS'); ?></h3>
                                </div>
                                <div class="plan-info">
                                    <p class="text-center"><?php echo JText::_('COM_JUX_REAL_ESTATE_PROPERTY_SUBMIT_LIMIT'); ?>: 5</p>
                                    <p class="text-center"><?php echo JText::_('COM_JUX_REAL_ESTATE_FEATURED_PROPERTY'); ?>: 1</p>
                                    <p class="text-center"><?php echo JText::_('COM_JUX_REAL_ESTATE_DAY'); ?>: 
                                        <?php
                     ...
                     <div class="jux-col-md-6" >
                        <form action="" method="post" id="adminForm" name="adminForm">
                            <div class="login-heading">
                                <h3><?php echo JText::_('COM_JUX_REAL_ESTATE_PLEASE_LOGIN_TO_BUY_OUR_PRODUCT'); ?></h3>
                            </div>
                           
                            <div class="username">
                                <label for="lg_username"><?php echo JText::_('COM_JUX_REAL_ESTATE_USER_NAME'); ?> <span>*</span></label>
                    ...
                    <div class="jux-col-md-6">
                        <div class="yet-account">
                            <div class="register-heading">
                                <h3><?php echo JText::_('COM_JUX_REAL_ESTSTE_DONT_HOVE_AN_ACCOUNT'); ?></h3>
                            </div>
                          <a id="toggle-billing-form" href="javascript:void(0);" class="jse-btn-m toggle-billing-form"> <?php echo JText::_('COM_JUX_REAL_PURCHASE_NOW'); ?></a> or 
                            <span> <a href="<?php echo JUX_Real_EstateRoute::_('index.php?option=com_users&view=registration'); ?>"><?php echo JText::_('COM_JUX_REAL_GO_TO_REGSITER_FORM'); ?></a></span>
                        </div>
                    </div>     
                </div>
            </div>    
    ...
    <div id="jse_purchase-form" class="jux-col-sm-7 jux-col-md-8 agentprofile-right <?php if(!$this->user->get('id')){echo 'purchase-hide';}?>">
        <fieldset class="agent-information">
            <div>
                <h1 class="agentprofile-title a-infomation"><?php echo JText::_('COM_JUX_REAL_ESTSTE_AGENT_INFOMATION'); ?></h1>
                ...
                <div class="agentprofile-group>">
                    <div class="group-container jux-row">
                        ...
                        <div class="jux-col-xs-12 jux-col-sm-12 jux-col-md-12" id="sh_moredetail">
                            <h3 class="show_hide" href="javascript:void(0);" title="" attr-text="1"><?php echo JText::_('COM_JUX_REAL_ESTSTE_ADD_MORE'); ?></h3>
                        </div>
                    ...
                    <div  id="socialnetwork" class="agentprofile-group more-info">
                        <h3 class="agentprofile-title" href="javascript:void(0);"> <?php echo JText::_('COM_JUX_REAL_ESTSTE_SOCIAL_NETWORK'); ?></h3>
