        ...
        <div class="avatar-thumb">
            ...
            if ($this->configs->get('agent_show_image', 1)) {
                if ($this->agent->avatar):
                    echo '<a class="agent_link" href="' . $agentlink . '"><img class="img-responsive" src="' . JUri::root() . $this->agent->avatar . '" alt="' . $this->agent->username . '" border="0" /></a>';
                else:
                    echo '<a class="agent_link" href="' . $agentlink . '"><img class="img-responsive" src="' . JUri::root() . '/components/com_jux_real_estate/assets/images/no-image.jpg' . '" alt="' . JText::_('COM_JUX_REAL_ESTATE_NO_IMAGE') . '" border="0" /></a>';
                endif;
            }
            ?>
        </div>
...
<div class="right-content">
    <div class="agent-detail">
        <h4 class="agent-detail-title"><?php echo JText::_('COM_JUX_REAL_ESTATE_AGEN_TREALTIES_CONTANT_INFO');?></h4>
        ...
        <div class="agent-desc">
            <h4 class="agent-detail-title"><?php echo JText::_('COM_JUX_REAL_ESTATE_AGEN_TREALTIES_ABOUT_ME');?></h4>
            <?php
...
<div class="jux-col-xs-12 jux-col-sm-12 jux-col-md-12">
    <?php if ($this->configs->get('agentdetail_contact_form')) : ?>
        <div class = "contact-agent">
            <h2 class="content-title"><?php echo JText::_('COM_JUX_REAL_ESTATE_AGEN_TREALTIES_CONTACT_ME');?></h2>
            <form method="post">
                <div class="jux-row">
                    <div class="jux-col-xs-5 jux-col-sm-5">   
                        <input name="name" id="agent_contact_name" type="text" placeholder="<?php echo JText::_('COM_JUX_REAL_ESTATE_YOUR_NAME'); ?>" aria-required="true" class="form-control">
                        ...
                        <input type="text" name="user_phone" class="form-control" id="agent_phone" placeholder="<?php echo JText::_('COM_JUX_REAL_ESTATE_YOUR_PHONE'); ?>">
                    </div>
                    <div class="jux-col-xs-7 jux-col-sm-7">
                        <textarea id="agent_comment" name="content" class="form-control" cols="45" rows="8" aria-required="true" placeholder="<?php echo JText::_('COM_JUX_REAL_ESTATE_MESSAGE'); ?>"></textarea>
                    </div>
                </div>
                <div class="jux-row">
