...
<div class="list-style realty-item">
    <div class= "jux-col-xs-12 jux-col-sm-5 jux-col-md-5 realty-image">
		...
		if ($this->item->preview_image) {
		    echo '<a class="agent_link" href="' . $realtylink . '"><img class="img-responsive" src="' . JUri::root() . $this->item->preview_image . '" alt="' . $this->item->alias . ' " border="0" /></a>';
		} else {
		    echo '<a class="agent_link" href="$this->item->realtylink"><img class="img-responsive" src="' . JUri::root() . '/components/com_jux_real_estate/assets/images/no-image.jpg' . '" alt="' . JText::_('COM_JUX_REAL_ESTATE_NO_IMAGE') . '" style="height:200px; width:374px;" /></a>';
		}
		?>
            </div>
        </div>
    ...
    <div class= "jux-col-xs-12 jux-col-sm-7 jux-col-md-7 realty-wrap">
        ...
        <div class="realty-summary">
            <div class="realty-detail">
                <div class="size"><span><?php echo $this->item->sqft; ?>  <?php echo $munits ;?></span></div>
                <div class="bedrooms"><span><?php echo $this->item->beds; ?></span></div>
                <div class="bathrooms"><span><?php echo $this->item->baths; ?></span></div>
            </div>
            <div class="realty-info">
                <div class="realty-price"><?php echo $this->item->formattedprice; ?>
                </div>
                <div class="realty-action"><a href="<?php echo $this->item->realtylink; ?>"><?php echo JText::_('COM_JUX_REAL_ESTATE_MORE_DETAIL');?></a>
                </div>
            </div>
        </div>
    </div>
