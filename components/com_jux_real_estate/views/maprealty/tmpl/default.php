...
<script type="text/javascript">
	...
	downloadUrl(url, function(data) {
		...
		htmls += '<tr><td colspan="2">\n\
                            <span class="gs-dd-link" style="cursor: pointer">Directions</span>\n\
                               </td></tr>';
		htmls += '<tr>\n\
			    <td colspan="2">\n\
...
<div class="row-fluid">
    <div class="col-xs-12 span12">
	    ...
	    <?php if ($this->params->get('enable_sidebar')): ?>
    		...
    		<div style="width: 100%" id="flip" align="right"><?php echo JText::_('COM_JUX_REAL_ESTATE_MAP_REALTY_CLICK_TO_SELECT_REALTY'); ?></div>
