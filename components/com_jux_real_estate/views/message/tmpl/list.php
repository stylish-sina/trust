...
<div class="jux-row agentprofile">
    <div class="agentprofile-left jux-col-sm-4 jux-col-md-4 ">
        ...
        <h3 class="dashboard-sidebar-title"><?php echo JText::_('COM_JUX_REAL_ESTATE_MESSAGE_YOUR_CURRENT_PACKAGE'); ?></h3>
        <div class="agentprofile-left-wrapper">
            <div class="agentprofile-left-menu dashboard-sidebar">
    ...
    <div class="jux-col-sm-8 jux-col-md-8 agentprofile-right">
        <h1 class="agentprofile-title"><?php echo JText::_('COM_JUX_REAL_ESTATE_MY_MESSAGE'); ?></h1>
        <div class="agentprofile-content">
            <table class="table table-hover" cellspacing="0"  align="center" cellpadding="0" border="0" width="100%">
                ...
                <tbody>
                    ...
                    if ($this->messages) {
                        foreach ($this->messages as $message) {
                            ...
                            echo '<td>' . $realty . '</td>';
                            //echo ($status) ? '<td>'.$subject.'</td>' : '<td><strong>'.$subject.'</strong></td>';
