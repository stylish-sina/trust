...
<form action="index.php" method="post"
    ...
    <div class="row">
        <div col-xs-12">
             <div>
                <span style="font-size: 90%"><?php echo JText::_('COM_JUX_REAL_ESTATE_YOUR_NAME'); ?></span> 
                <span style="font-size: 80%">(*<?php echo JText::_('COM_JUX_REAL_ESTATE_MESSAGE_REQUIRED'); ?>)</span>
                <input required class="span12" name="name" id="name" maxlength="50" type="text"   value="<?php echo $this->user->name; ?>" />
            </div>

            <div>
                <span style="font-size: 90%"><?php echo JText::_('COM_JUX_REAL_ESTATE_MESSAGE_YOUR_EMAIL'); ?></span> 
                <span style="font-size: 80%">(*<?php echo JText::_('COM_JUX_REAL_ESTATE_MESSAGE_REQUIRED'); ?>)</span>
		...
		<span style="font-size: 80%">(*<?php echo JText::_('COM_JUX_REAL_ESTATE_MESSAGE_REQUIRED'); ?>)</span><br>
            ...
            <input class="btn btn-info btn-small" name="Reset" value="Reset" type="reset">
        </div>
    ...
    <input type="hidden" name="toemail" id="toname" value="<?php echo JRequest::getString('toname', ''); ?>" />
</form>