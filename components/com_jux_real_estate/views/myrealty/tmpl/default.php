...
<div class="row">
	...
	<div class="properties list my-properties">
		...
		<h1 class="page-title"><?php echo JText::_('COM_JUX_REAL_ESTATE_MY_REALTY_MY_PROPERTIES'); ?></h1>
	    </div>
	    <?php foreach ($this->items as $item) : ?>
    		...
    		<article class="hentry">
				...
				echo '<img src="' . JUri::root() . $item->preview_image . '" alt=" " border="0" /></a>';
			    } else {
				echo '<img src="' . JUri::root() . '/components/com_jux_real_estate/assets/images/no-image.jpg' . '" alt="' . JText::_('COM_JUX_REAL_ESTATE_NO_IMAGE') . '" style="height:200px;" /></a>';
			    }
			    ?>
    			</a>
    			...
    			<div class="property-summary">
    				...
    				<div class="size">
    				    <span><?php echo $item->sqft; ?> <?php echo JText::_('COM_JUX_REAL_ESTATE_SQFT'); ?></span>
    				</div>
    				<div class="bathrooms">
    				...
    				<div class="property-price">
    				    <span><span class="amount"><?php echo $item->price; ?></span> /<?php echo JText::_('COM_JUX_REAL_ESTATE_MONTHS'); ?></span>
    				</div>
	...
	function ajaxUpdate(task, id, name) {
		...
		onComplete: function(response) {
			...
			case 'reject':
			    ...
			    string = '<img src="<?php echo'components/com_jux_real_estate/assets/images/tick.png'; ?>" border="0" alt="<?php echo JText::_('COM_JUX_REAL_ESTATE_APPROVED'); ?>" />';
			    break;
			case 'approve':
			    log.title = '<?php echo JText::_('COM_JUX_REAL_ESTATE_APPROVE'); ?>';
			    string = '<img src="<?php echo 'components/com_jux_real_estate/assets/images/rejected.png'; ?>" border="0" alt="<?php echo JText::_('COM_JUX_REAL_ESTATE_REJECTED'); ?>" />';
			    break;
			case 'publish':
			    log.title = '<?php echo JText::_('COM_JUX_REAL_ESTATE_PUBLISH'); ?>';
			    string = '<img src="<?php echo 'components/com_jux_real_estate/assets/images/publish_x.png'; ?>" border="0" alt="<?php echo JText::_('COM_JUX_REAL_ESTATE_UNPUBLISH'); ?>" />';
			    break;
			case 'unpublish':
			    log.title = '<?php echo JText::_('COM_JUX_REAL_ESTATE_UNPUBLISH'); ?>';
			    string = '<img src="<?php echo 'components/com_jux_real_estate/assets/images/tick.png'; ?>" border="0" alt="<?php echo JText::_('COM_JUX_REAL_ESTATE_PUBLISHED'); ?>" />';
			    break;
			    // sold
			case 'sold':
			    log.title = '<?php echo JText::_('COM_JUX_REAL_ESTATE_SOLD'); ?>';
			    string = '<img src="<?php echo 'components/com_jux_real_estate/assets/images/available.png'; ?>" border="0" alt="<?php echo JText::_('COM_JUX_REAL_ESTATE_UNSOLD'); ?>" />';
			    break;
			case 'unsold':
			    log.title = '<?php echo JText::_('COM_JUX_REAL_ESTATE_UNSOLD'); ?>';
			    string = '<img src="<?php echo 'components/com_jux_real_estate/assets/images/sold2.png'; ?>" border="0" alt="<?php echo JText::_('COM_JUX_REAL_ESTATE_SOLD'); ?>" />';
			    break;
		    }
