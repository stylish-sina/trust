...
<div class="list-style realty-item">
    <div class= " jux-col-xs-12 jux-col-sm-5 jux-col-md-5 realty-image">
	    ...
	    <?php endif; ?>
            <div class="status">
                <div class="type"><?php echo JUX_Real_EstateHTML::getTypeTitle($this->item->type_id); ?>
                </div>
		<?php
...
//                                var_dump($image);die;
		...
		?>    
                <div class="mask">
                    <?php echo '<a href="'. JUri::root() . $this->item->preview_image . '" class="info fancybox-effects-a jux-fa jux-fa-search" title="'.$this->item->title.'"></a>';?>
                </div>
            </div>
        </div>
    </div>
    <div class= "jux-col-xs-12 jux-col-sm-7 jux-col-md-7 realty-wrap">
        ...
        <div class="realty-summary">
            <div class="realty-detail">
                <div class="size"><span><?php echo $this->item->sqft . $munits; ?></span></div>
