                        ...
                        <div class="slide-caption-info">
                            ...
                            <div class="info-summary">
                              <?php if($params->get('show_area')==1){  ?>
                                <div class="size">
                                    <span><?php echo $realty->sqft; ?> <?php echo JText::_('MOD_JUX_REAL_ESTATE_SLIDER_SHOW_SQFT');?></span>
                                </div>
                          ...
                          <div class="slide-caption-action">
                            <?php if($params->get("show_readmore")==1) {?>
                              <a href="<?php echo $realtylink; ?>"><?php echo JText::_('MOD_JUX_REAL_ESTATE_SLIDER_SHOW_MORE_DETAILS');?></a>
                            <?php }?>
                          </div>
                    </div>
                </li>
