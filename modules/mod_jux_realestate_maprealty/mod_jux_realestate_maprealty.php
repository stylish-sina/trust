...
$document->addScript('http://maps.googleapis.com/maps/api/js?libraries=places&key='.$params->get('gmapapikey','AIzaSyC65Cru0kXK7Ftn0C7IA2BZ3UeYO5Y0kGU').'&sensor=false');
