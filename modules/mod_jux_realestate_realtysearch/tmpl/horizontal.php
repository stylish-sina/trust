...
<div id="realty-search-horizontal" class="realty-search-horizontal clearfix">
...
<form id="ZJSearchForm" action="<?php echo JRoute::_($link_search); ?>" method="get" name="ZJSearchForm">
    ...
    <div cellspacing="0" cellpadding="0" border="0" class="jux-search-form">
        <div class="keyword-field">
            <input class="keyword" placeholder="<?php echo JText::_('MOD_JUX_REALESTATE_REALTYSEARCH_SEARCH_KEYWORD'); ?>" type="text" name="title" id="title" value="<?php if (isset($post['title'])) echo $post['title']; ?>" />
        </div>
        ...
        <?php if ($advance) { ?>
            <div>
                <div width="100%" cellspacing="0" cellpadding="0" border="0" id="advanced_search" style="<?php if (!$toggle) { ?>display:block;<?php } else { ?>display:none;<?php } ?>">
