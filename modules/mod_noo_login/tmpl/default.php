					...
					<div class="noologin-form" id="noologin_register">
						<form method="post" action="<?php echo JRoute::_('index.php', true, false); ?>">
							<div class="control-group">
								...
								<input id="jform_name" class="required " type="text" required="required" size="30" value="" name="jform[name]" aria-="true">
							</div>
							<div class="control-group">
								<label for="jform_username"><?php echo JText::_('MOD_NOO_LOGIN_VALUE_USERNAME') ?>: <span class="star"> *</span></label>
								<input id="jform_username" class="required " type="text" required="required" size="30" value="" name="jform[username]">
							</div>
							<div class="control-group">
								<label for="jform_password1"><?php echo JText::_('MOD_NOO_LOGIN_VALUE_PASSWORD') ?>: <span class="star"> *</span></label>
								<input id="jform_password1" class="validate-password required " type="password" required="required" size="30" autocomplete="off" value="" name="jform[password1]">
							</div>
							<div class="control-group">
								<label for="jform_username"><?php echo JText::_('MOD_NOO_LOGIN_VALUE_REPASSWORD') ?>: <span class="star"> *</span></label>
								<input id="jform_password2" class="validate-password required " type="password" required="required" size="30" autocomplete="off" value="" name="jform[password2]">
							</div>
							<div class="control-group">
								<label for="jform_email1"><?php echo JText::_('MOD_NOO_LOGIN_VALUE_EMAIL') ?>: <span class="star"> *</span></label>
								<input id="jform_email1" class="validate-email required " type="email" required="required" size="30" value="" name="jform[email1]">
							</div>
							<div class="control-group">
								<label for="jform_email2"><?php echo JText::_('MOD_NOO_LOGIN_VALUE_REEMAIL') ?>: <span class="star"> *</span></label>
								<input id="jform_email2" class="validate-email required" type="email" required="required" size="30" value="" name="jform[email2]">
							</div>
