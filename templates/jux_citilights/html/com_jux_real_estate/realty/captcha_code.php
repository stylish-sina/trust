...
class CapCha {
    ...
    public function getImgCapcha() {
        ...
        $newImage = imagecreatefromjpeg("components/com_jux_real_estate/views/realty/tmpl/bg_captcha.jpg");
        $txtColor = imagecolorallocate($newImage, 0, 0, 0);
        imagestring($newImage, 5, 5, 5, $ranStr, $txtColor);
        imagejpeg($newImage);
        $rawImageBytes = ob_get_clean();
        echo "<img src='data:image/jpeg;base64," . base64_encode($rawImageBytes) . "' alt='#' />";
    }
}
