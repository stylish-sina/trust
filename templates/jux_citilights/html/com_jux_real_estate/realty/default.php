    ...
    <div class="jux-col-xs-12 jux-col-sm-12 jux-col-md-12">
        <div class="realty-summary jux-row">
            <div class="property-detail jux-col-xs-12 jux-col-md-4 jux-col-sm-4">
                <h4 class="property-detail-title"><?php echo JText::_('COM_JUX_REAL_ESTATE_PROPERTY_DETAILS'); ?></h4>
                <div class="property-detail-content">
                    <div class="detail-field jux-row">
                        ...
                        <span class="jux-col-md-7 jux-col-sm-7 jux-col-xs-7 detail-field-value price-value">
                            <?php echo $this->item->sqft; ?> <?php echo $munits;?>
                        </span>
            ...
            <?php if ($this->item->description): ?>
                <div class="property-desc jux-col-md-7 jux-col-sm-7 jux-col-xs-12">
                    <h4 class="property-detail-title"><?php echo JText::_('COM_JUX_REAL_ESTATE_PROPERTY_DESCRIPTION'); ?></h4>
                </div>
            ...
            <div class="realty-map">
                ...
                <div class="map-direction">
                    <select id="mode" class="" onchange="updateMode()">
                        <option value="driving"><?php echo JText::_('COM_JUX_REAL_ESTATE_DRIVING'); ?></option>
                        <option value="bicycling"><?php echo JText::_('COM_JUX_REAL_ESTATE_BICYCLING'); ?></option>
                        <option value="walking"><?php echo JText::_('COM_JUX_REAL_ESTATE_WALKING'); ?></option>
                    </select>
                ...
                <div class="contact-agent">
                    <form role="form" id="conactagentform" method="post">
                        <div class="form-group">
                            <input required  class="form-control" name="name" id="name"  type="text" value="<?php echo $this->user->name; ?>" placeholder="<?php echo JText::_('COM_JUX_REAL_ESTATE_YOUR_NAME'); ?> *">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <textarea required  name="content" class="form-control" id="content" placeholder="<?php echo JText::_('COM_JUX_REAL_ESTATE_MESSAGE'); ?> *"></textarea>
                        </div>
                        <div class="form-group">
                            <div class="form-action">
                                <?php if ($this->configs->get('enable_capcha') == 1) { ?>
                                   ...
                                   ?>        
                                <?php } ?>
                                <button type="submit"  class="btn btn-info btn-small" name="Send a Message" value="<?php echo JText::_('COM_JUX_REAL_ESTATE_SEND'); ?>" onClick="sendContact();"><?php echo JText::_('COM_JUX_REAL_ESTATE_SEND_A_MESSAGE');?></button>
                            </div>    
                        </div>
    ...
    <div class="jux-col-xs-12 jux-col-sm-12 jux-col-md-12 agent-more-properties">
        ...
        if (count($this->agentRealty)) {
            ...
            <div class="more-properties-title">
                <h3><?php echo JText::_('COM_JUX_REAL_ESTATE_MY_PROPERTIES'); ?></h3> 
            </div>
