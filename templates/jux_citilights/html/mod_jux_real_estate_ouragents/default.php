...
<?php foreach ($agents as $agent): ?>
            ...
            <?php if ($params->get('show_image') == 1) { ?>
                    ...
                    <?php if ($agent->avatar): ?>
                                ...
                                ?>
                            <?php else: ?>
                                <img class="img-responsive" src="<?php echo JUri::root() . '/components/com_jux_real_estate/assets/images/no-image.jpg'; ?>" border="0" alt="" />;
                            <?php endif; ?>
                        </div>
                    <?php } ?>
                    ...
                    <?php } if ($params->get("show_icon") == 1) { ?>
                        <div class="ouragents-ion">
                            <ul>                                  
                                ...
                                <li>
                                    <div class="linkedin">
                                        <a href="<?php echo $agent->googleplus; ?>" target="_blank"><i class="fa fa-linkedin"></i></a>
                                    </div>
                                </li>
                                <li>
                                    <div class="google">
                                        <a href="<?php echo $agent->googleplus; ?>" target="_blank"><i class="fa fa-pinterest"></i></a>
                                    </div>
                                </li>  
                            </ul> 
                        </div>
...
<script type="text/javascript">
    jQuery(window).load(function () {
        jQuery("#jux_real_estate_ouragents<?php echo $module->id ?> #owl-demo<?php echo $module->id; ?>").owlCarousel({
            autoPlay:<?php if ($params->get('autoplay') == 0) echo 'false';
        else {
            echo $params->get('animation_speed');
        } ?>,
            items:<?php echo $params->get("count", 3); ?>,
            stopOnHover: <?php if ($params->get('stop0nHover', 'false') == 0) echo 'false';
        else echo 'true'; ?>,
            itemsDesktop: [1199, 3],
