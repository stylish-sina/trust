            ...
            <?php if ($params->get('text_image') == 'imagein') { ?>    
                <div class="real_slider realty-item clearfix imagein cot<?php echo $params->get('count') ?>">
                    <figure class="tag status">
                        <div class="type">
                            <?php echo JUX_Real_EstateHelperQuery::getType($realty->type_id); ?>                 
                        </div>
                        <?php
                        if ($datediff->format('%a') < $configs->new_days):
                            echo '<div class="new">'.JText::_("MOD_JUX_REALTY_ESTATE_NEW").'</div>';
                        endif;
                        ?>
                    </figure>               
                    <div class="banners">
                ...
                <div class="mod-properties realty-item clearfix imageon cot<?php echo $params->get('count') ?>">                
                    <div class="realty-image">
                        <div class="thumb-holder">
                            ...
                            <div class="status">
                                <div class="type"><?php echo JUX_Real_EstateHelperQuery::getType($realty->type_id); ?>
                                </div>
                                <?php
                                if ($datediff->format('%a') < $configs->new_days):
                                    echo '<div class="new">'.JText::_("MOD_JUX_REALTY_ESTATE_NEW").'</div>';
                        ...
                        <div class="realty-summary">
                            ...
                            <div class="realty-info">
                                ...
                                <div class="realty-action">
                                    <?php if ($params->get('show_readmore') == 1) { ?> <a href="<?php echo $realtylink; ?>"><?php echo JText::_('MOD_JUX_REAL_ESTATE_PROPERTIES_MORE_DETAILS');?></a><?php } ?>
