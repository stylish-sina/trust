...
if (file_exists($helix3_path)) {
    ...
    helix3::addJS('input-effect-classie.js'); // JS Files
}
...
function sp_ajax_contact_addon($atts){
	...
	$output .= '<div class="sppb-form-group input">';
	$output .= '<input name="name" class="input-field sppb-form-control" id="input-name" required="required" placeholder="Your Name*">';
	$output .= '</div>';

	$output .= '<div class="sppb-form-group input">';
	$output .= '<input type="email" name="email" class="sppb-form-control input-field" id="input-email" required="required" placeholder="Your Email*">';
	$output .= '</div>';

	$output .= '<div class="sppb-form-group input">';
	$output .= '<input name="subject" class="sppb-form-control input-field" id="input-subject" required="required" placeholder="Subject">';
	$output .= '</div>';

	if($formcaptcha) {
		$output .= '<div class="sppb-form-group input">';
		$output .= '<input type="text" name="captcha_question" class="sppb-form-control input-field" id="captcha_question" required="required">';
		$output .= '<label class="input-label" for="captcha_question">
						<span class="input-label-content">'. $captcha_question .'</span>
					</label>';
		$output .= '</div>';
	}

	$output .= '<div class="sppb-form-group input input-field-textarea">';
	$output .= '<textarea name="message" rows="5" class="sppb-form-control input-field" id="input-message" required="required" placeholder="Your Message"></textarea>';
	$output .= '</div>';
