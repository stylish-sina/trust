...
function sp_call_to_action_addon($atts){
	...
	$button_output = '<a href="' . $button_url . '" class="sppb-btn sppb-btn-' . $button_type . ' sppb-btn-' . $button_size . ' ' . $button_block . '" role="button" >' . $button_text . '</a>';
	...
	if($button_position=='right') {
		...
		$output .= '<div class="sppb-text-left">';
		...
		if($text) $output .= '<p class="sppb-cta-text" style="color:#fff;">' . $text . '</p>';
